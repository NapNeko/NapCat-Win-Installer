...
//https://dldir1.qq.com/qqfile/qq/QQNT/cc326038/QQ9.9.21.39038_x64.exe
const std::wstring QQ_DOWNLOAD_URL = L"https://dldir1.qq.com/qqfile/qq/QQNT/cc326038/QQ9.9.21.39038_x64.exe";
const std::wstring QQ_EXE_PATH = L"QQ.exe";
const std::wstring QQ_EXTRACT_DIR = L"NapCat.39038.Framework";
...
int main()
{
    ...
    else
    {
        ...
        std::vector<std::wstring> mirrorUrls = {
            L"https://j.1win.ggff.net/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://git.yylx.win/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://ghfile.geekertao.top/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://gh-proxy.net/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://ghm.078465.xyz/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://gitproxy.127731.xyz/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://jiashu.1win.eu.org/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
            L"https://github.tbedu.top/https://github.com/NapNeko/NapCatQQ/releases/latest/download/NapCat.Framework.zip",
